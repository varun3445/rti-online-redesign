  ...
  return (
    <main>
      ...
      <section className="ux4g-container ux4g-py-2xl">
        ...
        <h1 className="ux4g-heading-xl-strong ux4g-my-m">{whatIsRti.title}</h1>
        ...
        <div className="ux4g-grid ux4g-grid-auto-fit-300 ux4g-gap-m ux4g-my-m">
          {whatYouCanGet.map((item, i) => {
            ...
            return (
              <article
                key={item.title}
                className="ux4g-card ux4g-card-outline ux4g-card-vertical ux4g-shadow-l2"
              >
      ...
      <section className="ux4g-bg-primary-soft ux4g-py-2xl">
        <div className="ux4g-container">
          <h2 className="ux4g-heading-l-strong">Have something specific you need?</h2>
